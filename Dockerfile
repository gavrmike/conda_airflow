...
# spark
RUN conda install -y -c conda-forge -c cyclus python=3.6 java-jdk pyspark==2.3.1 bokeh matplotlib sympy seaborn pyhive sqlalchemy pyarrow flower airflow[all]==1.10.1 psycopg2 tornado=5.0.2 && pip install h2o
